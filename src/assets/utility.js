...
function timeConversion(millisec) {
    ...
    else if (days < 365) return days + " Days";
...
function toTb(n) {
    return (n / (1000 * 1000 * 1000 * 1000)).toFixed() + " TB";
}
...
function getNetHost(net) {
    var mainnet = "http://127.0.0.1";
    ...
    if (net.toLowerCase() == "testnet") {
        console.log("net>>" + net.toLowerCase());
